...
const CategoryBags = () => {
  ...
  const handleQuoteRequest = (productNumber: number) => {
    const message = `Olá! Gostaria de solicitar um orçamento para Bolsas - Produto ${productNumber}`;
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="text-center mt-16 bg-gradient-to-r from-purple-600 to-purple-700 rounded-2xl p-8 md:p-12 text-white">
          <h3 className="text-2xl md:text-3xl font-bold mb-4">
            Gostou de alguma bolsa?
          </h3>
          <p className="text-purple-100 mb-8 max-w-2xl mx-auto">
            Entre em contato conosco pelo WhatsApp para mais informações sobre preços e disponibilidade.
          </p>
          <Button 
            asChild 
            size="lg" 
