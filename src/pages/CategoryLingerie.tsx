...
const CategoryLingerie = () => {
  ...
  const handleQuoteRequest = (productNumber: number) => {
    const message = `Olá! Gostaria de solicitar um orçamento para Lingerie - Produto ${productNumber}`;
...
export default CategoryLingerie;
